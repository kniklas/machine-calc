...
- [X] **T013** Add `tests/integration/test_cli_material_types.py` — 21 tests covering the two-step
...
- [X] **T020** Verify quality gates: `ruff` ✓, `black` ✓, `mypy` ✓, `bandit` ✓, Maintainability Index
      rank A ✓, Sphinx `-W` ✓, pytest 299 passed / 8 skipped at 98.32% coverage ✓ (`registry.py` 100%)
