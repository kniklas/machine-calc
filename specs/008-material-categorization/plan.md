...
| **II. Testing Standards** | Unit tests for all logic, ≥90% coverage, CI | ✅ Pass | 62 new tests (35 registry, 22 CLI, 5 i18n); suite at 305 passed / 8 skipped, 98.32% total coverage, `registry.py` at 100%. |
...
├── integration/test_cli_material_types.py         # 22 tests (new)
