...
| **II. Testing Standards** | Unit tests for all logic, ≥90% coverage, CI | ✅ Pass | 41 new tests (30 registry, 11 CLI); suite at 284 passed / 8 skipped, 98.39% total coverage, `registry.py` at 100%. |
...
├── integration/test_cli_material_types.py         # 11 tests (new)
