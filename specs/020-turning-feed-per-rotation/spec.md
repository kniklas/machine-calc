...
- Per the resolved Clarification (Session 2026-09-12), the existing feed rate result field's meaning and unit stay unchanged for turning, and drilling/milling remain untouched by this feature; the per-rotation value is exposed as a new, additional, turning-specific field rather than a redefinition.
