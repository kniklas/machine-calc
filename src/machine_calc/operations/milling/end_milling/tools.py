...
the shared :mod:`machine_calc.registry_config` helper. The parsing and
validation itself lives in :mod:`machine_calc.operations.milling._tool_registry`
...
from machine_calc.operations.milling._tool_registry import MillingTool, build_registry

_BUNDLED_PACKAGE = "machine_calc.operations.milling.end_milling.data"
...
class EndMillTool(MillingTool):
    ...
    Adds no fields to :class:`~machine_calc.operations.milling._tool_registry.MillingTool`;
